...
export const enterLesson = (lessonId) => ({
    lessonId,
    type: types.ENTER_LESSON
});
export const overviewLesson = (lessonId) => ({
    lessonId,
...
export const setLessonInProgress = (lessonId) => ({
    lessonId,
...
export const setLessonToSync = (lessonToSync) => ({
    lessonToSync,
