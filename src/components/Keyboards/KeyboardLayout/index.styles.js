...
export const GSKeyText = glamor(GSCustomText)(Object.assign({}, textStyle, { color: Colors.white }));
export const GSIcon = glamor(Icon)(Object.assign({}, textStyle, { color: Colors.white, alignSelf: 'center', marginLeft: 10, fontSize: 25, width: 40, transform: [{ rotate: '180deg' }] }));
...
export const GSButton = glamor.touchableOpacity({
    width: 78,
