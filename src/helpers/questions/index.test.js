...
describe('common', () => {
    ...
    describe('clearAnswer', () => {
        ...
        it('it clears answers from commas and fullstops', () => {
            expect(h.cleanAnswer('there should be no commans, and fullstops.')).toEqual('there should be no commans and fullstops');
        });
        ...
        it('it clears answers from special chars', () => {
            expect(h.cleanAnswer('<th!is -is$_ gonna@ be clear from=: special chars/%;>')).toEqual('this is gonna be clear from special chars');
        });
    });
});
