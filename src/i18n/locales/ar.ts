export default {
  ...
  general: {
    ...
    retry: {
      ...
      reason:
        'فشل البرنامج بالاتصال مع مخدم سوريولينجو. ' +
    ...
    GENERAL_API: {
      ...
      messages: {
        passwordRecoverySuccess:
          'سيتم ارسال رسالة لك إلى البريد الالكتروني في غضون ثوان',
        passwordRecoveryFailure:
          'يبدو وأن هذا البريد غير موجود لدينا. حاول مجدداً',
      },
    },
  },
  levels: {
  ...
  courses: {
    ...
    alerts: {
      commingSoon: {
        ...
        description:
          ' فريق عمل سوريولينجو مشغول في إنشاء المنهاج والمحتوى المناسب ' +
          'وسيتم إعلامك حالما تصبح الدورة جاهزة.',
  ...
  signon: {
    ...
    alerts: {
      signOut: {
        title: 'هل انت متأكد؟',
        description:
          'إن خرجت من التطبيق سيتم حذف كل معلوماتك الشخصية والدراسية من التطبيق، ولكن ستبقى كل هذه البيانات على السرفر، لذا تستطيع ان تسترجع جميع بياناتك باعادة الدخول من هذه الجهاز أو من آخر.',
        cancel: 'إلغاء الخروج',
        ok: 'اخرج',
      },
      signupReason: {
        ...
        description:
          'لكي تحفظ تقدمك في الدراسة من الضياع\nيُفضّل ان تقوم بتسجيل حساب خاص.',
      },
      signinReason: {
        title: 'ادخل إلى سوريولينجو',
        description:
          'إن كنت قد سجلك مسبقاً ولديك حساب على سوريولينجو فتستطيع ادخال الإيميل وكلمة السر ومتابعة دراستك.',
      },
      signupName: {
      ...
      signinPassword: {
        title: 'كلمة المرور',
        description:
          'إن كنت قد نسيت كلمة المرور للدخول إلى حسابك إلى سوريولينجو فعليك الضفط على رابط "نسيت كلمة السر"',
      },
      failedToLoginViaFacebook: {
        title: 'تعذر التسجيل عن طريق الفيسبوك',
        description:
          'لم يستطع تطبيق سوريولينجو الاتصال بالفيسبوك بسبب خطأ تقني قد يكون متعلق بالفيسبوك نفسه.',
      },
    ...
    form: {
      ...
      errors: {
        ...
        nameInvalid:
          'عليك اختيار اسم مؤلف من أحرف عربية أو سريانية أو انكليزية',
  ...
  passwordRecovery: {
    ...
    result: {
      success:
        'لقد تم ارسال الطلب لتغيير كلمة السر,' +
        ' وستستلم رسالة على بريدك الالكتروني في غضون ثوان.',
      failure:
        'يبدو أنك لم يسبق وأن سجلت حساباً بهذا الإيميل, أو أنك أدخلت الإيميل الخطأ',
    },
    links: {
